...
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: string, arg1: string, arg2: string, arg3: Array<OrderItem>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateOrderStatus(arg0: bigint, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
